...
(define (domain basic-viajes)
  ...
  (:action siguiente-ciudad
    ...
    :precondition (and (in ?ciutat1) (not-visited ?ciutat2) (transporte ?ciutat1 ?ciutat2) (localizado ?ciutat2 ?htl)   
                  (or (and (>= (+ (dias_city) 1) (min_days_city)) (<= (+ (dias_city) 1)(max_days_city))) (starting ?ciutat1)))
  ...
  (:action misma-ciudad
    ...
    :precondition (and (in ?ciutat1) (localizado ?ciutat1 ?htl) (not (starting ?ciutat1)) (<= (+ (dias_city) 1)(max_days_city)))
