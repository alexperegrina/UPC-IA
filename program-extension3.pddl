...
(define (problem ten-cities)
  ...
  (:init (transporte c1 c2) (transporte c1 c3) (transporte c2 c4)
         ...
         (= (precio_transporte (transporte c1 c2)) 150) 
         (= (precio_transporte (transporte c1 c3)) 250)  
         (= (precio_transporte (transporte c2 c4)) 350) 
         (= (precio_transporte (transporte c2 c5)) 450) 
         (= (precio_transporte (transporte c3 c6)) 110) 
         (= (precio_transporte (transporte c3 c7)) 250) 
         (= (precio_transporte (transporte c4 c8)) 50)  
         (= (precio_transporte (transporte c4 c9)) 70)  
         (= (precio_transporte (transporte c5 c10)) 190) 
         (= (precio_transporte (transporte c5 c1)) 950) 
         (= (precio_transporte (transporte c6 c2)) 1150) 
         (= (precio_transporte (transporte c6 c3)) 250) 
         (= (precio_transporte (transporte c7 c4)) 50) 
         (= (precio_transporte (transporte c7 c5)) 20) 
         (= (precio_transporte (transporte c8 c6)) 50) 
         (= (precio_transporte (transporte c8 c7)) 80) 
         (= (precio_transporte (transporte c9 c8)) 250) 
         (= (precio_transporte (transporte c10 c1)) 250))
