...
(define (problem ten-cities)
  ...
  (:init (transporte c1 c2) (transporte c1 c3) (transporte c2 c4)
         ...
         (= (precio_transporte c5 c1) 250) 
         (= (precio_transporte c6 c2) 450) 
         ...
         (= (interes c9) 3)
         (= (interes c10) 1))
  (:goal (and (>= (min_total_dias_rec) 12) (>= (precio_total) 300) (<= (precio_total) 3000) (<= (dias_city) (max_days_city)) (>= (dias_city) (min_days_city)) (= (total_ciudades) 4)))
  (:metric minimize (+ (* 75 (interes_total)) (precio_total)))
